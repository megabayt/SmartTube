...
public class PlaybackFragment extends SeekModePlaybackFragment implements PlaybackView {
    ...
    public void onResume() {
        ...
        ExoPlayerInitializer.enableAudioFocus(mPlayer, PlayerTweaksData.instance(getContext()).isAudioFocusEnabled()); // Restore focus after PIP
    }
    ...
    public void onPause() {
        ...
        if (isEngineBlocked()) {
            ExoPlayerInitializer.enableAudioFocus(mPlayer, false); // Disable focus in PIP/background
        }
    }
